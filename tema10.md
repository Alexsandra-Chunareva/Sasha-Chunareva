...
if __name__ == '__main__':
    print(fibonacci(100))
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/1.png)
...
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/2.png)
...
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/3.png)
...
if __name__ == '__main__':
    ...
    check_name(name)
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/4.png)
...
if __name__ == '__main__':
    ...
    print('>> Сайт выключен')
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/5.png)
...
if __name__ == "__main__":
    fibonacci()
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/s1.png)
...
if __name__ == "__main__":
    ...
    if data:
        ...
        print("Файл пустой")
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/s2.png)
...
add_two_to_input()
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/s3.png)
...
multiply_by_ten(5)
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/s4.png)
...
if __name__ == "__main__":
    ...
    print(checked_value)
```
![Меню](https://github.com/Alexsandra-Chunareva/Sasha-Chunareva/blob/tema10/скринs/s5.png)
